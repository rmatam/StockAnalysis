...
def LoadData(filename, FractionTest=.1, Classification=True):
    ...
    if Classification:
        Test_Y=np.sum(Test_Y.reshape(N_Test,2,100),axis=2) # instead of 0 or 1 in 200 classes (bin in pT), see if any of them are 1
